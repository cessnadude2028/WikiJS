...
## Setting the IP
First thing your going to want to do is set the IP inside of _WAYSTATION_pos-db.xml, This is critical as it lets the KVS and all the other devices see the WayStation. The picture shows the file's location.![screenshot_2026-02-08_051845.png](/screenshot_2026-02-08_051845.png)
